              ...
              content: SingleChildScrollView(
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Start Date Picker untuk Surat Sakit
                      TextFormField(
                      ...
                      // End Date Picker untuk Surat Sakit
                      TextFormField(
  ...
  Widget _buildScaffold(
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: Theme.of(context).primaryColor,
        onPressed: () => _showAddSakitForm(context),
    ...
    return BlocBuilder(
      ...
      builder: (context, state) {
        if (appController.getAttendanceListMap.isEmpty) {
          return const Center(child: Text('Tidak ada data surat sakit'));
        }
