              ...
              content: SingleChildScrollView(
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Start Date Picker untuk Surat Izin
                      TextFormField(
                      ...
                      // End Date Picker untuk Surat Izin
                      TextFormField(
                      ...
                      // Perihal untuk Surat Izin
                      TextFormField(
                        controller: _keperluanController,
                        decoration: const InputDecoration(
                          labelText: 'Perihal',
                          border: OutlineInputBorder(),
                          hintText: 'Masukkan perihal izin',
                        ),
                        maxLines: 3,
                        validator: (value) {
                          if (value == null || value.isEmpty) {
  ...
  Widget _buildScaffold(
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: Theme.of(context).primaryColor,
        onPressed: () => _showAddIzinForm(context),
    ...
    return BlocBuilder(
      ...
      builder: (context, state) {
        if (appController.getAttendanceListMap.isEmpty) {
          return const Center(child: Text('Tidak ada data surat izin'));
        }
